  ...
  return (
    <div>
      <table className="table">
        <thead>
          <tr><th>ID</th><th>FirstName</th><th>LastName</th><th>email</th><th>Role</th><th>Edit</th><th>Delete</th></tr>
        </thead>
        <tbody>
          {data && data.getAllFriends.map(f => (
            <tr key={f.id}>
              ...
              <td>{f.email}</td>
              <td>{f.role}</td>
              <td><AddFriend allowEdit={true} initialFriend={f}/></td>
              <td><DeleteFriend email={f.email}/></td>
            </tr>
          ))}
        </tbody>
      </table>
